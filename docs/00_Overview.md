...
> - [`docs/platform/01_System_Overview.md`](platform/01_System_Overview.md) — full system diagram + component matrix
> - [`docs/platform/02_Service_Design.md`](platform/02_Service_Design.md) — service inventory with correct ports
> - [`docs/platform/03_Multi_Tenancy.md`](platform/03_Multi_Tenancy.md) — 7-layer tenant isolation model
> - [`docs/platform/04_Security_Model.md`](platform/04_Security_Model.md) — auth flows + Istio/OPA security chain
> - [`docs/platform/05_Data_Model.md`](platform/05_Data_Model.md) — PostgreSQL ER diagram + schema layout
>
