...
| **Assumed** | An estimate or a figure from an unverifiable secondary source | Prefix "Assumed:" and say what it's based on |
...
4. `product-os/ai-product-strategy/` and linked specs/roadmaps — for `[Spec: …]`
5. Web / competitor material — for `[Source: …]`, only the fixed competitor set
